...
draft: false
tags: ["excel","microsoft","software"]
description: "Hide the value of a cell if its neighbouring cell is zero or blank"
summary: "I have an Excel spreadsheet that I use to keep track of all my business expenses.In order to make it less cluttered, and easier on the eye, I wanted to get rid of all the repeated, irrelevant values in the columns that may not have an entry for each day."
---
