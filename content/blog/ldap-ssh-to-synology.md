...
draft: false
tags: ["devops","ldap","security","ssh","synology"]
description: "Securing the connection to your NAS"
summary: "Users created with Synology's LDAP Server have their login shell set to /sbin/nologin. Add the following to the end of /usr/syno/etc/nslcd.conf if you want to enable SSH logins to your NAS for your LDAP users."
---
